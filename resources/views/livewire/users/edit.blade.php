    ...
    <form wire:submit="update">
        <div class="space-y-4">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-slate-700 mb-1">
                    New Password <span class="text-slate-500 text-xs">(Leave blank to keep current)</span>
                </label>
            ...
            <div class="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-start gap-2">
                    ...
                    <div class="text-xs text-blue-800">
                        <p class="font-medium mb-1">Editing User #{{ $userId }}</p>
                        <p class="text-blue-700">Only fill in the password fields if you want to change the password.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-slate-200">
            ...
            <button type="submit" wire:loading.attr="disabled"
                class="px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
