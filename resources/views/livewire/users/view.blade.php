    ...
    <div class="mt-6 space-y-4">
        ...
        <div class="flex items-center justify-between py-3 border-b border-slate-100 dark:border-slate-800/60">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-slate-600 dark:text-slate-400">User ID</span>
            </div>
            <span class="text-sm font-semibold text-slate-900 dark:text-slate-100">#{{ $user->id }}</span>
        </div>
        ...
        <div class="flex items-center justify-between py-3 border-b border-slate-100 dark:border-slate-800/60">
            ...
            <span class="text-sm text-slate-900 dark:text-slate-200">{{ $user->email }}</span>
        </div>
        ...
        <div class="flex items-center justify-between py-3 border-b border-slate-100 dark:border-slate-800/60">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-slate-600 dark:text-slate-400">Email Verified</span>
            </div>
            ...
            @else
                <span class="flex items-center gap-1 text-sm text-slate-500 dark:text-slate-450">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
        ...
        <div class="flex items-center justify-between py-3 border-b border-slate-100 dark:border-slate-800/60">
            ...
            <div class="text-right">
                <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ $user->created_at->format('M d, Y') }}</p>
                <p class="text-xs text-slate-500 dark:text-slate-400">{{ $user->created_at->format('h:i A') }}</p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between py-3 border-b border-slate-100 dark:border-slate-800/60">
            ...
            <div class="text-right">
                <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ $user->updated_at->format('M d, Y') }}</p>
                <p class="text-xs text-slate-500 dark:text-slate-400">{{ $user->updated_at->format('h:i A') }}</p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between py-3">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-slate-600 dark:text-slate-400">Account Age</span>
            </div>
            <span class="text-sm text-slate-900 dark:text-slate-200">{{ $user->created_at->diffForHumans() }}</span>
        </div>
    </div>
