    ...
    <div class="w-full">
        <div class="mb-2 flex items-center justify-between gap-4 flex-wrap">
            ...
            <div class="flex items-center gap-3">
                @if (method_exists($this, 'exportPdf'))
                    <button wire:click="exportPdf"
                        class="inline-flex items-center px-4 py-1.5 bg-rose-600 border border-rose-600 rounded-sm text-sm font-medium text-white hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all duration-200">
                        <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10h2a2 2 0 002-2V6a2 2 0 00-2-2h-2m0 0V2a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2h4m2-4H4m0 0v-4" />
                        </svg>
                        Export PDF
                    </button>
                @endif
                @if (method_exists($this, 'exportExcel'))
                    <button wire:click="exportExcel"
                        class="inline-flex items-center px-4 py-1.5 bg-emerald-600 border border-emerald-600 rounded-sm text-sm font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all duration-200">
                        <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
