        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                <div class="mb-6">
                    ...
                    <x-text-input id="name" type="text" placeholder="Supplier Name" class="mt-1 block w-full"
                ...
                <div class="mb-6">
                    ...
                    <x-text-input id="phone" type="text" placeholder="Phone" class="mt-1 block w-full"
            ...
            <!-- Right Side: Address & Status -->
            <div>
                <div class="mb-6">
                    <x-input-label for="address" :value="__('Address')" />
                    <x-textarea id="address" wire:model="address" placeholder="Address here..."
                        rows="4"
                        class="mt-1 block w-full">{{ old('address', $supplier->address ?? '') }}</x-textarea>
